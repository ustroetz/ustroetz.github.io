...
otp.core.TransitIndex = otp.Class({
    ...
    loadAgencies : function(callbackTarget, callback) {
        ...
        var url = otp.config.routerUrl + '/transit/agencyIds';
        $.ajax(url, {
            dataType:   'jsonp',
    ...
    loadRoutes : function(callbackTarget, callback) {
        ...
        var url = otp.config.routerUrl + '/transit/routes';
        $.ajax(url, {
            dataType:   'jsonp',
    ...
    loadVariants : function(agencyAndId, callbackTarget, callback) {
        ...
        var url = otp.config.routerUrl + '/transit/routeData';
        $.ajax(url, {
            data: {
    ...
    readVariantForTrip : function(tripAgency, tripId, callbackTarget, callback) {
        ...
        var url = otp.config.routerUrl + '/transit/variantForTrip';
        $.ajax(url, {
            data: {
    ...
    runStopTimesQuery : function(agencyId, stopId, startTime, endTime, callbackTarget, callback) {
        ...
        var url = otp.config.routerUrl + '/transit/stopTimesForStop';
        $.ajax(url, {
            data:       params,
            dataType:   'jsonp',
    ...
    loadStopsInRectangle : function(agencyId, bounds, callbackTarget, callback) {
        ...
        var url = otp.config.routerUrl + '/transit/stopsInRectangle';
        $.ajax(url, {
            data:       params,
            dataType:   'jsonp',
