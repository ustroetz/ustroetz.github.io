...
otp.core.IndexApi = otp.Class({
    ...
    loadAgencies : function(callbackTarget, callback) {
        ...
        var url = otp.config.routerUrl + '/index/agencies';
        $.ajax(url, {
    ...
    loadRoutes : function(callbackTarget, callback) {
        ...
        var url = otp.config.routerUrl + '/index/routes';
        $.ajax(url, {
            success: function(data) {
                if(_.isEmpty(data)) {
    ...
    loadVariants : function(agencyAndId, callbackTarget, callback) {
        ...
        var url = otp.config.routerUrl + '/index/routes/' + agencyAndId ;
        $.ajax(url, {
            success: function(data){
    ...
    loadPattern : function(routeId, patternId) {
        var this_ = this;
        var url = otp.config.routerUrl + '/index/patterns/' + patternId ;
        $.ajax(url, {
            async: false,
            success: function(data) {
    ...
    runStopTimesQuery : function( stopId, date, callbackTarget, callback) {
        ...
        var url = otp.config.routerUrl + '/index/stops/' + stopId + '/stoptimes/' + date;
        $.ajax(url, {
            //data:       params,
    ...
    loadStopsInRectangle : function(agencyId, bounds, callbackTarget, callback) {
        ...
        var url = otp.config.routerUrl + '/index/stops';
        $.ajax(url, {
            data:       params,
    ...
    loadRoutesForStop : function(agencyId, callbackTarget, callback) {
        ...
        var url = otp.config.routerUrl + '/index/stops/' + agencyId + '/routes';
        $.ajax(url, {
            success: function(data) {
                callback.call(callbackTarget, data);
            }
...
/* to be implemented
    loadStopsById : function(agencyId, id, callbackTarget, callback) {
        ...
        var url = otp.config.routerUrl + '/transit/stopData';
        $.ajax(url, {
            data:       params,
            dataType:   'jsonp',
    ...
    loadStopsByName : function(agencyId, name, callbackTarget, callback) {
        ...
        var url = otp.config.routerUrl + '/transit/stopsByName';
        $.ajax(url, {
            data:       params,
            dataType:   'jsonp',
