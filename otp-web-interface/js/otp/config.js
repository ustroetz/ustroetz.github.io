otp.config = {
     ...
     */
    routerUrl : "http://localhost:8080/otp/routers/default",
    ...
    baseLayers: [
        {
            name: 'Mapbox OSM',
            tileUrl: 'https://{s}.tiles.mapbox.com/v4/allryder.kd8ho2cd/{z}/{x}/{y}.png?access_token=pk.eyJ1IjoiYWxscnlkZXIiLCJhIjoidWs5cUFfRSJ9.t8kxvO3nIhCaAl07-4lkNw',
        },
